...
class AiBot:
    ...
    def __init__(self, welcome_message:str, assistant_functions:List[dict]={}, run_step_callback=None):
        ...
        assert "OPENAI_GPT_ASSISTANT_ID" in st.secrets, f"OPENAI_GPT_ASSISTANT_ID not found in secrets.toml file."
        openai_assistant_id = st.secrets["OPENAI_GPT_ASSISTANT_ID"]
